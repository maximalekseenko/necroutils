...
#ifndef INCLUDE_NECROUTILS_COLEXC_COLLECTIVE_EXCEPTION_H_
#define INCLUDE_NECROUTILS_COLEXC_COLLECTIVE_EXCEPTION_H_
...
#endif  // INCLUDE_NECROUTILS_COLEXC_COLLECTIVE_EXCEPTION_H_
